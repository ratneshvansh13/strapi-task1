...
export interface ApiVanshVansh extends Struct.CollectionTypeSchema {
  collectionName: 'vanshes';
  info: {
    displayName: 'Vansh';
    pluralName: 'vanshes';
    singularName: 'vansh';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::vansh.vansh'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
